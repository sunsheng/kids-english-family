...
- 一个家庭账号管理多名学员（学员不是独立账号），在「设置」页维护学员档案。
- 每名学员可设置：学段（小学/初中/高中）、具体年级、教材版本（人教版/北师大版等 19 个版本）、发音口音。
- 「选词库」默认按上述设置自动筛选出推荐词书，可切换「全部词书」并按学段/版本/关键词继续筛选。
- 学习进度按 学员 x 词书 保存：切换词书时原计划自动暂停、进度保留，切回后继续学习。
- 拼写测试进度独立于学习进度，同样按 学员 x 词书（即不同学段/学期/版本）隔离，按"一阶段一阶段"（默认 10 词/阶段）顺序推进。
